...
void bsodFatal(const char *component)
{
	...
	if (f)
	{
		...
		stringFromFile(f, "stbmodel", "/proc/enigma/model");
		stringFromFile(f, "stbbrand", "/proc/enigma/brand");
		stringFromFile(f, "stbplatform", "/proc/enigma/platform");
		stringFromFile(f, "socfamily", "/proc/enigma/socfamily");
		...
		stringFromFile(f, "architecture", "/proc/enigma/architecture");
		stringFromFile(f, "rctype", "/proc/enigma/rctype");
		stringFromFile(f, "rcname", "/proc/enigma/rcname");
		stringFromFile(f, "rcidnum", "/proc/enigma/rcidnum");
		stringFromFile(f, "compiledby", "/proc/enigma/developername");
