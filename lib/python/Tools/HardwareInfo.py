...
class HardwareInfo:
	...
	def __init__(self):
		...
		self.device_name = BoxInfo.get("model")
		self.device_brandname = BoxInfo.get("brand")
		self.device_model = BoxInfo.get("model")
		...
		self.device_hdmi = BoxInfo.get("hdmi")  # Only some early DMM boxes do not have HDMI hardware.
